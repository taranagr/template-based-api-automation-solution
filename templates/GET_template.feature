...
#    Given Product Access Token API with body "product_token_body.json" and headers "product_token_headers.json"
    ...
    Examples:
      ...
      | product_url | empty_body.json  | product_headers.json  | 200                  | Google Pixel 6 Pro |
...
#    Given Product Access Token API with body "product_token_body.json" and headers "product_token_headers.json"
    ...
    Examples:
      | URL Name    | Body Template Name | Headers Template Name | Expected Status Code | Expected Message     |
      | product_url | empty_body.json  | product_headers.json  | 200                  | Apple MacBook Pro 16 |

  Scenario Outline: Get_Product_03: Get Product API with Invalid Product ID in the URL
#    Given Product Access Token API with body "product_token_body.json" and headers "product_token_headers.json"
    When Use Invalid Product Id "<Product Id>"
    And Run Product GET API with URL "product_url", body "empty_body.json" and headers "product_headers.json"
